    ...
    private function init(){
                ...
                $this->fields[] = array(
                                    ...
                                    'help'  => array(
                                                    sprintf(__('Please use this field for possibility to use coupon discounts by your visitors.' ,'booking'),'<code><strong>[coupon my_coupon]</strong></code>') 
                                                        . ' ' . sprintf(__('You can configure the discount coupon codes at this %spage%s.' ,'booking'),'<a href="' . wpbc_get_settings_url() . '&tab=email">','</a>')
                                                    , '<strong>' . __('Important!' ,'booking') . '</strong> '. sprintf(__('You can %suse this shortcode only once%s in the form.' ,'booking'),'<strong>','</strong>')
                                        )
                                   );
        ...
        $this->fields[] = array(
            ...
            $this->fields[] = array(
                                ...
                                'help'  => array(                                                                                                     
                                      '<code><strong>'.'[resource_title_hint]'                  .'</strong></code> - ' . __('title of booking resource' ,'booking') . '. '                                                                            
...
<!--        <div style="float:right;margin:10px 0px !important;width:40%;" class="wpdevelop booking_settings_row">-->
        <div class="wpdevelop booking_settings_row">
            ...
            <div id="wpbc_field_help_selector" class="wpbc_field_help_panel_background form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block"><?php _e('Select option to configure or show help info about tags' ,'booking'); ?></p>
                </div>
            </div>
    ...
    <style type="text/css" media="screen">
        ...
        #wpbc_field_help_selector .form-group {
            margin:0;
        }
