...
// Include CSS & JS files
	function fanatic_scripts() {
		...
		wp_enqueue_style( 'font-style', 'https://fonts.googleapis.com/css?family=Raleway:100,200,400,500,600,700' );
		// Theme Scripts
		wp_enqueue_script( 'theme-scripts', get_template_directory_uri().'/js/script.min.js', array( 'jquery','slick-scripts' ), '1.0' , true );
		wp_enqueue_script( 'slick-scripts', get_template_directory_uri().'/lib/plugins/slick/slick.min.js', array( 'jquery' ), '1.0' , true );
	}
